...
func RegisterAddressBookServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server AddressBookServiceServer) error {
	...
	mux.Handle("POST", pattern_AddressBookService_AddPerson_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/tutrial.AddressBookService/AddPerson", runtime.WithHTTPPathPattern("/tutrial.AddressBookService/AddPerson"))
		if err != nil {
...
func RegisterAddressBookServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client AddressBookServiceClient) error {
	...
	mux.Handle("POST", pattern_AddressBookService_AddPerson_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/tutrial.AddressBookService/AddPerson", runtime.WithHTTPPathPattern("/tutrial.AddressBookService/AddPerson"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_AddressBookService_AddPerson_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"tutrial.AddressBookService", "AddPerson"}, ""))
)
